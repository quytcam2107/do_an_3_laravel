...
class ApiBillController extends Controller
{
        public function getApiBill(){
            $users =DB::table('hoa_dons')->select('hoa_dons.*','phieu_dat_phongs.*','phieu_dat_phongs.nguoi_tao_phieu','khach_hangs.ho_ten_khach','phongs.ten_phong','nhan_viens.ten_nhan_vien')
